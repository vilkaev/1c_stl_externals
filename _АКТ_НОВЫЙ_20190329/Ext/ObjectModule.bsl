...
#Область Получить_ТабДок
	...
	//	ОбластьМакетаШапка.Параметры.Заполнить(СведенияОПоставщике);		
		...
		//
		//ОбластьПодвал.Параметры.ДолжностьПредставителяЗаказчика = СведенияОГрузополучателе.РуководительФИО;
		//ОбластьПодвал.Параметры.ПредставительЗаказчика = СведенияОГрузополучателе.ДОлжностьРуководителяПредставление;
